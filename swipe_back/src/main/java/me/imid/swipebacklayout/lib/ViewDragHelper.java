...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         * onViewCaptured(android.view.View, int)} will follow if the
     ...
     * processTouchEvent(android.view.MotionEvent)} receiving an
     * ACTION_CANCEL event.
     */
    public void cancel() {
     ...
     * { #processTouchEvent(android.view.MotionEvent)}. If one of these
     ...
     * #shouldInterceptTouchEvent(android.view.MotionEvent)} or
     *  #processTouchEvent(android.view.MotionEvent)}. You should only
